		...
		return (
			<div style={{'minHeight':1000}}>
				...
				<div className="wrap pos_re clearfix">
					<Aside cln="tree col-sm-2" context={_this.context} parentPath={_this.props.route.path} user="user"/>
...
UserWrap.contextTypes = {
	router: React.PropTypes.object.isRequired,
	store:React.PropTypes.object
};

let ConnectApp = connect(state => state)(UserWrap);
